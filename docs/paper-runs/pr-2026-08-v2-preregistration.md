...
| Field | Value |
|---|---|
| Run ID | `pr-2026-08-v2` — rename if you'd rather |
...
| Git commit | `5a4654b23b43887714e30790220056864dc9e0cd` *(deployed `master` commit on the bridge host at run start; this must continue to match the actually deployed code for the duration of the run)* |
